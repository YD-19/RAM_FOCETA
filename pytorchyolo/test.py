...
from pytorchyolo.utils.transforms import DEFAULT_TRANSFORMS, VAE_TRANSFORMS
...
def _create_data_loader(img_path, batch_size, img_size, n_cpu):
    ...
    :rtype: DataLoader
    """
    dataset = ListDataset(img_path, img_size=img_size, multiscale=False, transform=VAE_TRANSFORMS)
    dataloader = DataLoader(
        dataset,
        batch_size=batch_size,
        shuffle=False,
...
def run():
    ...
    parser.add_argument("-w", "--weights", type=str, default="data/yolov3_ckpt_33.pth", help="Path to weights or checkpoint file (.weights or .pth)")
